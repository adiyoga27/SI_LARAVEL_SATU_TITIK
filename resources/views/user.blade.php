            ...
            <div class="modal-content">
                ...
                <form action="{{ route('user.store') }}" method="POST"  enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-2 col-form-label">Akses</label>
                            <div class="col-md-10">
                                <select class="form-control" name="role">
                                    <option value="admin">Admin</option>
                                    <option value="cashier">Kasir</option>
                                    <option value="chief">Dapur</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3 row">
                ...
                <form id="form-edit" class="form-edit" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="password" name="password" id="password">
                                <p>Silahkan kosongkan jika tidak merubah password</p>
                            </div>
                        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        modal.find('#username').val(response.data['username']);
                        modal.find('#role').value = response.data['username'];
