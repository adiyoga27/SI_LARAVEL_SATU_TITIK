            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Data Biaya Tambahan</h4>
    ...
    <div class="modal fade" id="addForm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('additional-cost.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label for="example-text-input" class="col-md-2 col-form-label">Jumlah</label>
                            <div class="col-md-10">
                                <input class="form-control" type="number" name="amount" id="amount">
                                <p>Input Persentase 0.0 - 100.0 </p>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('additional-cost.index') }}",
                columns: [{
                        data: 'name',
                        name: 'name'
                    },
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status) {
                        ...
                        modal.find('#amount').val(response.data['amount']);
                    } else {
                        Swal.fire(
                            'Gagal!',
